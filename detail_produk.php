...
?>
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid #ff99cc"><b>Detail produk</b></h2>
		...
		<div class="col-md-8">
			<form action="proses/add.php" method="GET">
				...
				if(isset($_SESSION['user'])){
					?>
					<button type="submit" class="btn btn-success"><i class="glyphicon glyphicon-shopping-cart"></i> Tambahkan Data</button>
					<?php 
				}else{

					?>
					<a href="keranjang.php" class="btn btn-success"><i class=""></i> Tambahkan Data</a>
					<?php 
				}
				?>
