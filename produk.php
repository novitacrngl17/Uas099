...
<!-- PRODUK TERBARU -->
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid #333333"><b>Informasi Penduduk</b></h2>
					...
					<div class="caption">
						...
						<div class="row">
							...
							<?php if(isset($_SESSION['kd_cs'])){ ?>
								...
								?>
								<div class="col-md-6">
									<a href="keranjang.php" class="btn btn-success btn-block" role="button"><i class=""></i> Tambah</a>
								</div>
